#!/bin/bash
#SBATCH --job-name=woo_wgs_mark_dup_woodsorrel_v0.1_racon_x2_medaka_x2		# Job name 
...
O=bwa_mem_mapping/woo_aa_aln_to_woodsorrel_v0.1_racon_x2_medaka_x2.picard_qname_sorted.sam \
SORT_ORDER=queryname


#Mark duplicates with PICARD tools
java -Xmx100G -jar $EBROOTPICARD/picard.jar MarkDuplicates \
I=bwa_mem_mapping/woo_aa_aln_to_woodsorrel_v0.1_racon_x2_medaka_x2.picard_qname_sorted.sam \
O=bwa_mem_mapping/woo_aa_aln_to_woodsorrel_v0.1_racon_x2_medaka_x2.picard_qname_sorted.marked_dup.sam \
...
bwa_mem_mapping/woo_aa_aln_to_woodsorrel_v0.1_racon_x2_medaka_x2.picard_qname_sorted.marked_dup.sam
...
#sbatch woo_wgs_mark_dup_woodsorrel_v0.1_racon_x2_medaka_x2.sh
