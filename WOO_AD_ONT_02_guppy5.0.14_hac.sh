#!/bin/bash
#SBATCH --job-name=Guppy5.0.14_WOO_AD_02_ONT		# Job name
...
guppy_basecaller --input_path WOO_AD_ONT_02/WOO_AD_ONT_02/20210409_1335_MN25780_FAP44387_18c38c82/fast5 \
    --save_path basecalled_data/WOO_AD_ONT_02/WOO_AD_ONT_02_Guppy5.0.14_fastq \
...
#sbatch WOO_AD_ONT_02_guppy5.0.14_hac.sh
