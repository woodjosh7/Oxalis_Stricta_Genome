#!/bin/bash
#SBATCH --job-name=woodsorrel_v0.1_racon_x2_medaka_x2		# Job name 
...
conda activate /home/jcw61311/software/conda_envs/medaka_v1.4.4

medaka_consensus -m r941_min_hac_g507 -t 20 \
-i basecalled_data/woo_all_guppy5.0.14_10kb.fastq \
-d polishing/woodsorrel/medaka_x1/woodsorrel_v0.1_racon_x2_medaka_x1.fasta \
-o tuber_evolution/polishing/woodsorrel/medaka_x2/
...
#sbatch woodsorrel_v0.1_racon_x2_medaka_x2.sh
