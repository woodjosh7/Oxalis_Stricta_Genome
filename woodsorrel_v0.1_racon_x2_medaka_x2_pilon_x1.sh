#!/bin/bash
#SBATCH --job-name=woodsorrel_v0.1_racon_x2_medaka_x2_pilon_x1		# Job name 
...
java -Xmx600G -jar $EBROOTPILON/pilon-1.24.jar --genome polishing/woodsorrel/medaka_x2/woodsorrel_v0.1_racon_x2_medaka_x2.fasta \
--frags bwa_mem_mapping/woo_aa_aln_to_woodsorrel_v0.1_racon_x2_medaka_x2.marked_dup.sorted.bam \
--fix bases \
--output woodsorrel_v0.1_racon_x2_medaka_x2_pilon_x1 \
--outdir polishing/woodsorrel/pilon_x1/
...
#sbatch woodsorrel_v0.1_racon_x2_medaka_x2_pilon_x1.sh
