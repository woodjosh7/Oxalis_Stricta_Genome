#!/bin/bash
#SBATCH --job-name=Guppy5.0.14_WOO_AB_ONT		# Job name
...
guppy_basecaller --input_path WOO_AB_ONT_01/WOO_AB_ONT_01/20210406_1809_MN35355_FAP78943_c26bbc1f/fast5 \
    --save_path basecalled_data/WOO_AB_ONT_01/WOO_AB_ONT_01_Guppy5.0.14_fastq \
...
#sbatch WOO_AB_ONT_01_guppy5.0.14_hac.sh
