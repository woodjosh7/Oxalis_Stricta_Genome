#!/bin/bash
#SBATCH --job-name=Guppy5.0.14_WOO_AC_ONT		# Job name
...
guppy_basecaller --input_path WOO_AC_ONT_01/WOO_AC_ONT_01/20210406_1810_MN33056_FAP95503_5a9f5060/fast5 \
    --save_path basecalled_data/WOO_AC_ONT_01/WOO_AC_ONT_01_Guppy5.0.14_fastq \
...
#sbatch WOO_AC_ONT_01_guppy5.0.14_hac.sh
