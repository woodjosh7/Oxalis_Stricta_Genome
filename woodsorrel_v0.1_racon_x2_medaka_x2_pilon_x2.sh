#!/bin/bash
#SBATCH --job-name=woodsorrel_v0.1_racon_x2_medaka_x2_pilon_x2		# Job name 
...
java -Xmx600G -jar $EBROOTPILON/pilon-1.24.jar --genome polishing/woodsorrel/pilon_x1/woodsorrel_v0.1_racon_x2_medaka_x2_pilon_x1.fasta \
--frags bwa_mem_mapping/woo_aa_aln_to_woodsorrel_v0.1_racon_x2_medaka_x2_pilon_x1.marked_dup.sorted.bam \
--fix bases \
--output woodsorrel_v0.1_racon_x2_medaka_x2_pilon_x2 \
--outdir polishing/woodsorrel/pilon_x2/
...
#sbatch woodsorrel_v0.1_racon_x2_medaka_x2_pilon_x2.sh
