#!/bin/bash
#SBATCH --job-name=racon_x2_woodsorrel_v0		# Job name 
...
conda activate /home/jcw61311/software/conda_envs/racon_polish
...
polishing/woodsorrel/woodsorrel_v0.1_racon_x1.fasta > polishing/woodsorrel/woodsorrel_v0.1_racon_x2.fasta
...
#sbatch racon_x2_woodsorrel_v0.1.sh
